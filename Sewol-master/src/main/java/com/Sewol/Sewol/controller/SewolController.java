...
public class SewolController extends HttpServlet {
    ...
    @PostMapping("/student/exact")
    public Header<List<StudentDto>> findStudentExactName(@RequestParam("name") String studentName) {
    ...
    @PostMapping("/student/include")
    public Header<List<StudentDto>> findStudentIncludeName(@RequestParam("name") String studentName) {
    ...
    @PostMapping("/person/exact")
    public Header<List<PersonDto>> findByExactName(@RequestParam("name") String personName) {
    ...
    @PostMapping("/person/include")
    public Header<List<PersonDto>> findByIncludeName(@RequestParam("name") String personName) {
